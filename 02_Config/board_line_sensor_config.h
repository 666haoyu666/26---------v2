...
#define BOARD_LSENSOR_ENABLED_MASK (0x7F) /* 装配槽位位图，8路全装 */
#define BOARD_LSENSOR_ACTIVE_LOW   (1U)    /* 1=压线为低电平，待实测 */
#define BOARD_LSENSOR_PITCH_MM     (10.0f) /* 探头中心距mm，待实测占位 */
#define BOARD_LSENSOR_POSITIONS_MM  { -39.7f, -25.2f, -10.7f, 0.0f, 10.7f, 25.2f, 39.7f, 0.0f } /* 探头阵列坐标mm，右正左负，待实测占位 */
